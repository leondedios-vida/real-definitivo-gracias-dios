  ...
  return (
    ...
    <div className="h-screen supports-[height:100dvh]:h-[100dvh] w-full flex flex-col items-center p-4 selection:bg-[#D4AF37]/30 font-['Poppins'] text-white overflow-hidden relative">
      ...
      {!result ? (
        ...
        <div className="w-full max-w-[420px] fade-in flex flex-col items-center h-full relative pt-6 pb-0">
          
          {/* Header Texts removed for result view */}
          ...
          {/* Increased container height (h-24) and image width (w-[360px]) */}
          <div className="w-full h-24 relative z-10 flex justify-center overflow-hidden opacity-90 hover:opacity-100 transition-opacity duration-500 cursor-pointer flex-shrink-0">
              <div className="w-full h-full flex items-center justify-center relative">
                  <img 
                  src="https://cdn.shopify.com/s/files/1/0970/0029/2630/files/A.png?v=1770651402" 
                  alt="Continuar" 
                  className="absolute w-[360px] max-w-none h-[400%] object-cover object-center animate-float-dynamic mix-blend-screen drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] pointer-events-auto"
                  />
              </div>
          </div>
